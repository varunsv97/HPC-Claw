"""Session router for the repo-aware HPC assistant."""

from __future__ import annotations

from hpc_assistant_backend.assistant.hpc_sidecar import build_hpc_sidecar_routes
from hpc_assistant_backend.assistant.pgoa_skill import build_pgoa_routes
from hpc_assistant_backend.assistant.schema import ActionRoute, AssistantMode
