...
from claw_backend.pgoa.schema import ComputeMetrics, KPIMetrics, ProfileBundle, SlurmMetrics
from claw_backend.pgoa.services import collect_ncu_profile, collect_slurm_profile
...
class SharedServiceTests(unittest.TestCase):
    ...
    def test_collect_ncu_profile_preserves_existing_slurm_metrics(self):
        ...
        with mock.patch(
            "claw_backend.pgoa.services.SlurmAdapter.collect",
        ...
        with mock.patch(
            "claw_backend.pgoa.services.NCUAdapter.collect",
