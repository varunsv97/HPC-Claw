...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="HPC Claw backend — cluster discovery, PGOA optimization, and OpenCode integration."
    )
    ...
    assist_parser = subcommands.add_parser(
        "assist",
        help="Describe and persist a repo-aware HPC Claw session without replacing OpenCode's editing flow.",
    )
